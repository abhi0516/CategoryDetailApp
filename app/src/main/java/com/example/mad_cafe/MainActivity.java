        ...
        AdapterView.OnItemClickListener itemClickListener = new AdapterView.OnItemClickListener() {
            public void onItemClick(AdapterView<?> listView,
                ...
                if (position == 0) {                    // they chose breakfast
                    for (Food f : Food.myIceCream) {      // add all the elements for this array to the arraylist
                        listData.add(f);
                    }
                } else if (position == 1) {
                    for (Food f : Food.myShakes) {        // they chose lunch
                        listData.add(f);
                    }
                } else if (position == 2) {
                    for (Food f : Food.mySmoothies) {        // they chose dinner
                        listData.add(f);
                    }
                }
